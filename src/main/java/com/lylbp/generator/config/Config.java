...
public class Config {
     ...
     * 生成代码的包名
     */
    public static final String PACKAGE_NAME = "com.dar.app.biz.dispatch";
     ...
     * 项目路径
     */
    public static final String PROJECT_PATH = "/Library/WebServer/java_project/backend/dar-modules/dar-biz";

    /**
     * 代码路径
     */
    public static final String CODE_PATH = "/src/main/java/com/dar/app/biz/dispatch/";
     ...
     * 包名：xml
     */
    public static final String PACKAGE_NAME_XML = "mapper/dispatch";
     ...
     * 逻辑删除字段
     */
    public static final String FIELD_LOGIC_DELETE_NAME = "JLZT";
